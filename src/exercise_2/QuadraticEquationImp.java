...
import ra.entity.QuadraticEquation;
...
public class QuadraticEquationImp {
    public static void main(String[] args) {
        ...
        ra.entity.QuadraticEquation equation = new ra.entity.QuadraticEquation();
        ...
        ra.entity.QuadraticEquation equation1 = new QuadraticEquation(4, 9, 3);
        if (delta > 0) {
            //có hai nghiệm
